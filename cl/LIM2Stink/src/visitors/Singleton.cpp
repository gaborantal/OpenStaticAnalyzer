...
namespace columbus { namespace lim { namespace antipatterns {
  ...
  void SingletonVisitor::visit(const asg::logical::Class& _node, bool callVirtualBase) {
  ...
  void SingletonVisitor::visitEnd(const asg::logical::Class& _node, bool callVirtualBase) {
  ...
  void SingletonVisitor::visitEnd(const asg::logical::Method& _node, bool callVirtualBase) {
    VisitorAbstractNodes::visitEnd(_node);
